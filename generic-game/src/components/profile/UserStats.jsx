...
import { IoGameController, BiHappy, RiEmotionUnhappyLine } from 'react-icons/all';

export const UserStats = (({gamesWon, gamesLost, gamesPlayed, className = '', entryClassName = ''}) => {
  const baseIconClasses = 'mr-2 fill-curent';
  ...
  return <ul className={className}>
    ...
    <IoGameController className={playedIconClasses}></IoGameController> {gamesPlayed} games played.
    </li>
    <li className={entryClassName}>
    ...
    <li className={entryClassName}>
      <RiEmotionUnhappyLine className={lostIconClasses}></RiEmotionUnhappyLine>
