...
export const HomePage = () => {
  ...
  return <div className="p-4 container mx-auto">
    <h1>Welcome!</h1>
    {
      !established ? <CgSpinnerTwo className="animate-spin"></CgSpinnerTwo> : authenticated ? <UserStats {...stats} className = 'mt-8' entryClassName="p-5"></UserStats> : (<div className="text-center">
